...
const Messenger = () => {
    ...
    useEffect(() => {
        const getConversations = async () => {
            try {
                const res = await axios.get("https://soulmates-server-two.vercel.app/conversations/" + userInfo._id);
    ...
    useEffect(() => {
        const getMessages = async () => {
            try {
                const res = await axios.get("https://soulmates-server-two.vercel.app/messages/" + currentChat?._id);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post("https://soulmates-server-two.vercel.app/messages", message);
