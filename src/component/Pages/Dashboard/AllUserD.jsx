  ...
  return (
    <div className="w-full">
      <div>
        ...
        <div className="">
          <img
            src="https://i.ibb.co/swBsp3p/flower.png"
            alt=""
            className="lg:w-[20%] w-[60%] md:w-[40%] mx-auto -mt-1 mb-5"
          />
        </div>
      </div>
      <div className="overflow-x-auto">
        <table className="table">
          ...
          <tbody>
            {users?.map((user, index) => (
              <tr className="border-b-1 border-green-200" key={user._id}>
                <th>{index + 1}</th>
                <th className="w-16 h-16 object-cover">
        ...
        <table className="w-full text-sm text-left text-gray-500 overflow-hidden mt-5">
          ...
          {/* This is table body, adenied users goes here */}
