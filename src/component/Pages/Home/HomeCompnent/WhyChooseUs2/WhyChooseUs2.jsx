...
const WhyChooseUs2 = () => {
  return (
    <div className=' bg-opacity-30 mx-auto bg-primary-50 mt-[90px] ' >
      <div className="w-[80%] mx-auto py-[75px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 " >
          <div className="hover:scale-[1.009] hover:shadow  rounded-lg border border-gray-200 bg-white duration-150 flex flex-col gap-2 items-center py-7 px-6" data-aos="zoom-in" data-aos-duration="1000">
