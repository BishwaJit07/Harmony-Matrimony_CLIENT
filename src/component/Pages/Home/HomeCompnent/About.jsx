  ...
  return (
    <div className="  m-2">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 p-4">
        ...
        <div className=" font-mono">Welcome to Soulmate Matrimony, the ultimate destination for individuals seeking a lifelong partnership built on trust, compatibility, and love.</div>
