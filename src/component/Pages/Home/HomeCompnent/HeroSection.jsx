...
const HeroSection = () => {
  return (
    <div className="bg-[#FFFBF0]">
      <div className="  py-28 gap-8 flex justify-center items-center flex-col-reverse md:flex-row w-[80%] mx-auto">
        {/* contain */}
        <div className=" md:w-1/2 text-center md:text-left">
          ...
          <p className="text-base mt-5 lg:w-[70%] mb-5">
          ...
          <Link to="/">
            <button className="mt-3">
              <p className=" bg-[#D32C3D] text-white p-3 text-base font-semibold rounded-xl hover:bg-[#bc1828]">
                JOIN OUR PARTY
              </p>
            </button>
          </Link>
