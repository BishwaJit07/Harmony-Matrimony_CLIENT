  ...
  return (
    <div className="">
      ...
      <div className="flex select-none z-20 ">
        ...
        <div
          className={` ${
            open ? "md:w-[350px]  dark:bg-gray-500 dark:text-white" : "w-20"
          }  relative md:relative py-8 bg-[#F0F2F5] `}
        >
          <div className="flex items-center gap-6  bg-blue-500 w-[50px] md:hidden">
            <img
              src={sliderbtn}
              className={`absolute cursor-pointer -right-1  w-10 border-dark-purple border-2 rounded-full z-50 md:hidden   ${
                !open && "rotate-180"
              }`}
                        ...
                        <div key={marriage.id}>
                          <div className="flex gap-5 mt-1">
                            <label className="cursor-pointer block ">
                              ...
                              />
                              <div
                                className={`max-w-xl rounded-3xl p-1 text-gray-600 hover:shadow bg-[#e0e1e8] font-lato ${
                                  maritalStatus === marriage?.name
                      ...
                      <div key={value.id}>
                        <div className="flex gap-5 mt-1">
                          <label className="cursor-pointer block ">
                            ...
                            />
                            <div
                              className={`max-w-xl rounded-3xl p-1 text-gray-600 hover:shadow bg-[#e0e1e8] ${
                                religionStatus === value?.name
                                  ? "ring-2  peer-checked:text-[#51ac83]  peer-checked:ring-[#51ac83] "
                                  : "bg-gray-100"
                              }`}
                  ...
                  <div className="flex items-center space-x-4 ">
                    <Range
                      ...
                      renderThumb={({ props, index }) => (
                        ...
                        >
                          <span
                            className={`absolute -top-8  text-white  bg-[#21754f] p-[3px]  rounded-sm tooltip text-xs  ${
                              index === 0 ? "left-0" : "-right-[2px]"
                            }`}
                          >
                            {ageRange[index]}
                          </span>
