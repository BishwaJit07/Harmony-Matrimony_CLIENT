        ...
        <div className="">
          <div className="sticky top-4">
            ...
            <div className="flex justify-between gap-3 px-2 py-4">
              ...
              <button className="text-[17px] font-bold w-full bg-primary-500 rounded-full text-white py-4  flex justify-center items-center ">
                Sent Interested
              </button>
            </div>
          </div>
            ...
            <div className="w-[80%]">
              ...
              <div className="flex flex-col lg:flex-row w-full justify-between mt-4 gap-2 lg:">
                <div className="flex gap-4 ">
                  <button className="text-[15px] px-4 bg-primary-500 rounded-full text-white py-[10px] flex justify-center items-center gap-1">
                    <span>
